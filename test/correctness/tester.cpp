...
Tester<T,U>::Tester(int argc, char *argv[], const bool silent,
    ...
    platform_(Platform(GetArgument(argc, argv, help_, kArgPlatform, getenv("CLBLAST_PLATFORM"), size_t{0}))),
    device_(Device(platform_, GetArgument(argc, argv, help_, kArgDevice, getenv("CLBLAST_DEVICE"), size_t{0}))),
